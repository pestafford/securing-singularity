  ...
  const Banner = () => (
    <header className="flex justify-between items-center py-4 px-4 md:py-6 md:px-8 bg-surface border-b border-border-theme">
      ...
      <nav className="hidden md:flex items-center gap-6 md:gap-8">
        <a href="#services" className="text-body hover:text-[#1EAEDB] transition-colors font-mono text-sm tracking-wide">Services</a>
      ...
      <div className="flex items-center gap-2 md:hidden">
        <ThemeToggle />
        <button
          className="text-body hover:text-[#1EAEDB] transition-colors p-2"
        ...
        <>
          ...
          <nav className="fixed top-[73px] right-0 bottom-0 w-64 bg-surface-card shadow-2xl z-50 md:hidden overflow-y-auto border-l border-border-theme">
            <div className="flex flex-col p-6 space-y-4">
              <a
                href="#services"
                className="text-body hover:text-[#1EAEDB] transition-colors text-lg py-2 border-b border-border-theme font-mono"
                onClick={() => setIsMobileMenuOpen(false)}
              >
                Services
              </a>
      ...
      <div className="p-5 md:p-6 hover:shadow-lg transition-shadow max-w-xs md:max-w-sm mx-auto bg-surface-card rounded-lg border border-border-theme">
        <div className="flex flex-col items-center">
          ...
          <div className="flex flex-row items-center justify-center gap-4 mb-3">
            <a href={member.social.linkedin} target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="hover:text-[#1EAEDB] text-body transition-colors">
            ...
            <a href={member.social.github} target="_blank" rel="noopener noreferrer" aria-label="GitHub" className="hover:text-[#1EAEDB] text-body transition-colors">
      ...
      <div className="relative z-10">
            ...
            <div className="grid md:grid-cols-2 gap-8 items-center">
              ...
              <div className="flex justify-center md:justify-end md:pr-6 lg:pr-10">
                ...
                <img
                  ...
                  loading="lazy"
                  className="w-32 h-32 sm:w-40 sm:h-40 md:w-56 md:h-56 lg:w-64 lg:h-64 rounded-xl object-cover shadow-lg border-2 border-border-theme bg-surface-elevated animate-float"
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <ul className="grid md:grid-cols-3 gap-6 md:gap-8 list-none">
              {siteContent.services.items.map((service, index) => {
                ...
                return (
                  <li key={index} className="p-6 hover:shadow-2xl transition-all duration-300 rounded-xl border border-border-theme flex flex-col items-center text-center bg-surface-card hover:-translate-y-2 group hover:border-l-4 hover:border-l-[#1EAEDB]">
        ...
        <section className="py-12 md:py-16 px-2 md:px-6 bg-secondary relative overflow-hidden">
          ...
          <div className="max-w-6xl mx-auto relative z-10">
            ...
            <p className="text-center text-cyan-200 mb-10 max-w-2xl mx-auto">{siteContent.whyChooseUs.subtitle}</p>
        ...
        {/* Contact Section */}
        <section id="contact" className="py-12 md:py-16 px-2 md:px-6 bg-gradient-to-br from-[#0A2540] via-[#1E3A5F] to-[#14B8A6]">
          <div className="max-w-6xl mx-auto text-center">
            <h2 className="text-2xl md:text-3xl lg:text-4xl font-mono font-bold mb-6 text-white tracking-tight">
        ...
        <footer className="bg-surface border-t border-border-theme text-heading py-8 md:py-10 px-4 md:px-8">
          <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-8">
            <div>
              <h2 className="text-2xl font-bold text-heading mb-4 font-mono">{siteContent.company.name}</h2>
